...
return[
    ...
    'neighborhood' => $neighborhood_input_format = array(
        'neighborhood' => array(
            'label' => 'Name',
            'weight' => -90,
            'widget' => array(
    ...
    'volunteer_evaluation' => array(
        'volunteer_rating' => array(
            'label' => 'How do you rate your Chicago Greeter volunteer?',
            'type' => 'rating_textarea',
        ),
        'experience_rating' => array(
            'label' => 'How do you rate the experience using the Chicago Greeter program?',
            'type' => 'rating_textarea',
        ),
        'visit_description' => array(
            'label' => 'What did you and your Chicago Greeter do during your visit?',
            'type' => 'textarea',
        ),
        'visit_reflected_interests' => array(
            'label' => 'Did your visit reflect the area of interest you requested through registration?',
            'type' => 'radio_or_other',
            'options' => array(
                'Yes' => 'Yes',
                'No' => 'No',
        ...
        'visit_influence' => array(
            'label' => 'Did your Chicago Greeter influence your decision to visit any of the following attractions?  If so, which ones?',
            'type' => 'select_input',
            'options' => array(
        ...
        'use_program_again' => array(
            'label' => 'On your next visit to Chicago, will you use the Chicago Greeter program again?',
            'type' => 'yes_no',
        ),
        'public_transportation_during' => array(
            'label' => 'Did you use public transportation during your Chicago Greeter visit?',
            'type' => 'yes_no',
        ),
        'public_transportation_after' => array(
            'label' => 'Did you continue to use public transportation after your Chicago Greeter visit?',
            'type' => 'yes_no',
        ),
        'other_city' => array(
            'label' => 'Have you used a greeter program in another city?',
            'type' => 'yes_no_input',
            '_secondary' => array(
                'label' => "If so, what city?",
                'widget' => array(
                    'function' => 'form_input',
                    'params' => array(
                        'size' => 40,
        ...
        'recommend_service' => array(
            'label' => 'Would you recommend this service to a friend?',
            'type' => 'yes_no',
        ),
        'additional_notes' => array(
            'label' => 'Is there anything else you’d like to tell us about your experience?',
            'type' => 'textarea',
        ),
    ),
];
