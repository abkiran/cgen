...
function signalHandler($signo)
{
    global $running;
    $running = false;
    log_msg('Warning', "Interrupt received, killing SIDP server.");
}
...
function doit($db_name)
{
    ...
    for ($i=0; $i < $TABLES[0]['nrows']; $i++) {
        ...
        if ($table=='user'||$table=='system_setting') {
            continue;
        }
        // echo $module;
        // echo $class;

        // copy(BASEDIR.'base/ci_base/',OUTPUT_DIR.$db_name);
